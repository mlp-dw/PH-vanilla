    ...
    <div class="container-fluid ">
        ...
        {?>
            ...
            <div class="col-mb-3 text-end nav nav-pills">
                ...
                <div class="my-auto">
                    <a href="process/process_logout.php" style="text-decoration: none;" class="link-dark">Deconnexion <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
