...
function refreshPopular() {
    ...
    .then(function(value) {
        ...
        function filtreLikes(ups){
            // on affiche les likes existants
            return ups.filter((up) => {
                return up.up !== ""; 
            });
            
        }
        // trier par popularité les produit
            // on compare le produit A avec le produit B
