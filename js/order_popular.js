...
// function orderPopular() {
    
    fetch('./process/process_see_files_POPULAR.php') // Ce code permet d'envoyer une requête HTTP de type GET au service web
...
// //TOUTE LES SECONDES
//     setInterval(() => {
//     orderPopular ('../process/process_see_files_POPULAR.php')
//     }, 1000);
